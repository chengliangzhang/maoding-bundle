    ...
    Page.prototype = {
        ...
        ajaxCallBack: function (result) {
            ...
            if (total == null || total == undefined) {
                if (typeof this.options.remote.remoteWrongFormat === 'function') {
                    this.options.remote.remoteWrongFormat(result);
                }
                else {
                    if (console && typeof console.warn === 'function')
                        console.warn("the response of totalName :  '" + this.options.remote.totalName + "'  not found.");
