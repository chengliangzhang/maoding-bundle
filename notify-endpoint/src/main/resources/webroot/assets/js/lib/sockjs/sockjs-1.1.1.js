  ...
  function runInContext(context, exports) {
    ...
    if (!has("json")) {
      ...
      if (!has("json-parse")) {
        ...
        // Internal: Returns the next userToken, or `"$"` if the parser has reached
        // the end of the source string. A userToken may be a string, number, `null`
          ...
          while (Index < length) {
            ...
            switch (charCode) {
              ...
              case 123: case 125: case 91: case 93: case 58: case 44:
                // Parse a punctuator userToken (`{`, `}`, `[`, `]`, `:`, or `,`) at
        ...
        // Internal: Parses a JSON `value` userToken.
          ...
          if (typeof value == "string") {
            ...
            if (value == "[") {
              ...
              for (;; hasMembers || (hasMembers = true)) {
                ...
                // If the array literal contains elements, the current userToken
              ...
              for (;; hasMembers || (hasMembers = true)) {
                ...
                // If the object literal contains members, the current userToken
            ...
            // Unexpected userToken encountered.
            abort();
          }
          return value;
        };
