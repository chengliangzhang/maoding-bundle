...
public class StsServiceSample {
  ...
  public static void main(String[] args) {
    ...
    String accessKeyId = "LTAI5NGO9dG5rABy";
    String accessKeySecret = "YWe1ZPUNRUkaPgHmV5ovzhQkMIDhhr";
    // AssumeRole API 请求参数: RoleArn, RoleSessionName, Policy, and DurationSeconds
    // RoleArn 需要在 RAM 控制台上获取
    String roleArn = "acs:ram::1024029689061125:role/aliyunosstokengeneratorrole";
